...
function showLoginLoading(){
  ...
  if(!document.getElementById("google-login-style")){
    ...
    style.textContent = `
      ...
      #login-screen .login-logo-wrap{margin-bottom:26px !important;}
      ...
      #login-form{
        max-width:388px;margin:0 auto;padding:24px 18px 18px !important;
  ...
  if(!headline){
    ...
    headline.innerHTML = `
      <div style="text-align:center;margin-bottom:18px;">
        <h2 style="margin:0 0 10px;font-size:1.5rem;letter-spacing:-.045em;line-height:1.12;">Sign in to Bliptwit</h2>
        <p style="margin:0 auto;color:var(--text-muted);font-size:.9rem;line-height:1.55;max-width:284px;">Continue to your account and start messaging securely.</p>
      </div>
    `;
